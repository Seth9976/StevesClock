...
int32_t nWidth_1 = sub_407fc0(float.t(arg6) * x87_r5_1)
int32_t Y = sub_407fc0(x87_r6 * fconvert.t(arg5))
HWND hWnd = CreateWindowExA(arg9, "static", arg1, arg8, sub_407fc0(x87_r5_1 * fconvert.t(arg4)), Y, 
    nWidth_1, nHeight_1, arg2, arg3, hInstance, nullptr)
...
if (arg6 == 0)
    ...
    int32_t nWidth = data_424058
    int32_t Y_1 = sub_407fc0(fconvert.t(arg5) * fconvert.t(data_41bb08))
    MoveWindow(hWnd, sub_407fc0(fconvert.t(arg4) * fconvert.t(data_421f34)), Y_1, nWidth, nHeight, 
        1)
