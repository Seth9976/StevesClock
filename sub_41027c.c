        ...
        *__errno() = 9
        ...
        if ((*((&data_42ea00)[arg1 s>> 5] + esi_3 + 4) & 1) == 0)
            ...
            *___doserrno() = 0
            ...
            result_1 = sub_40fcc5(arg1, arg2, arg3)
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_2 = &data_410366
return result
